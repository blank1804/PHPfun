                ...
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-header">
                            <h1 class="formtitle">สมัครสมาชิก</h1>
                        </div>
                        <div class="card-body">
                            <form action="user_register_db.php" method="post">
                                ...
                                <div class="form-group row">
                                    <label for="c_user_password" class="col-md-4 col-form-label text-md-right">ยืนยันรหัสผ่าน</label>
                                    <div class="col-md-6">
                                        <input type="password" id="c_user_password" class="form-control" name="c_user_password">
                                    </div>
                                </div>
                                </br>
