                ...
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-header">
                            <h1 class="formtitle">เข้าสู่ระบบ Admin</h1>
                        </div>
                        <div class="card-body">
                            ...
                            <form action="login_admin_db.php" method="post">
                                ...
                                <div class="form-group row">
                                    <label for="admin_email" class="col-md-4 col-form-label text-md-right">E-Mail</label>
                                    <div class="col-md-6">
                                ...
                                <div class="col-md-6 offset-md-4">
                                    <button type="submit" name="alogin" class="btn btn-primary">
                                        เข้าสู่ระบบ
                                    </button>
